...
It is mandatory to choose the same problem statement as Round 1. Only choose the same problem statement if it aligns with the above provided Hackathon themes.
...
Each evaluator will judge about 10-15 teams during the judging process, submitting scores individually for each team. Once scores are submitted, the Cerebral Valley team will aggregate your scores with the other judge's scores to determine the top 6 finalist projects.